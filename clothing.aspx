<%@ Page Title="" Language="C#" MaintainScrollPositionOnPostback="true" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="clothing.aspx.cs" Inherits="WebShop.WebForm1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <p style="text-align: center;">
        Check Out the Latest WebShop Merch Below
    </p>
    ...
    <table style="margin-right: auto; margin-left:auto; border: 5px double #231f20 ; background: white; width: 50%">
        ...
        <tr>
            ...
            <td style="font-size: 15px">
                ...
                <asp:Button ID="btnBlackHoody" ValidationGroup="blackHoody" style="font-size: 15px; font-family: 'Courier New'" runat="server" Text="Add to Basket" BorderStyle="None" 
            ...
            <td style="font-size: 15px">
                ...
                <asp:Button ID="btnWhiteHoody" ValidationGroup="whiteHoody" style="font-size: 15px; font-family: 'Courier New'" runat="server" Text="Add to Basket" BorderStyle="None" 
                    onmouseover="this.style.color='#00FF90'"
    ...
    <table style="margin-right: auto; margin-left:auto; border: 5px double #231f20; background: white; width: 50%">
        ...
        <tr>
            ...
            <td style="font-size: 15px">
                ...
                <asp:Button ID="btnBlueJeans" ValidationGroup="blueJeans" style="font-size: 15px; font-family: 'Courier New'" runat="server" Text="Add to Basket" BorderStyle="None" 
                    onmouseover="this.style.color='#00FF90'"
            ...
            <td style="font-size: 15px">
                ...
                <asp:Button ID="btnGjeans" ValidationGroup="greyJeans" style="font-size: 15px; font-family: 'Courier New'" runat="server" Text="Add to Basket" BorderStyle="None" 
                    onmouseover="this.style.color='#00FF90'"
        ...
        <tr>
            ...
            <td style="font-size: 15px">
                ...
                <asp:Button ID="btnFlyer"  ValidationGroup="flyer" style="font-size: 15px; font-family: 'Courier New'" runat="server" Text="Add to Basket" BorderStyle="None" 
                    onmouseover="this.style.color='#00FF90'"

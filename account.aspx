<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="account.aspx.cs" Inherits="WebShop.WebForm2" %>
        ...
        <tr>
           <td colspan="2">
               <asp:Button ID="btnReset" runat="server" BackColor="White" BorderColor="#00FF90" BorderStyle="Solid" BorderWidth="1px" CssClass="auto-style1" Text="Reset" 
                    ...
                    onmouseout="this.style.color='black'" OnClick="btnReset_Click" Font-Size="20px" style="font-family: 'Courier New'"
                    />
                <asp:Button ID="btnLogin" runat="server" BackColor="White" BorderColor="#00FF90" BorderStyle="Solid" BorderWidth="1px" CssClass="auto-style1" Text="Login" 
                    onmouseover="this.style.color='#00FF90'"
                    onmouseout="this.style.color='black'" OnClick="btnLogin_Click" Font-Size="20px" style="font-family: 'Courier New'" />
               </td>
         </tr>

<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="basket.aspx.cs" Inherits="WebShop.WebForm3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <table style="font-size: 15px; text-align:left; margin-left:auto; margin-right:auto; margin-top: auto; border:5px double #231f20; background: #ffffff">
        ...
        <tr>
            <td>
                <asp:Button ID="btnClear"  style="font-size: 15px; font-family: 'Courier New'" runat="server" Text="Clear Basket" 
            ...
            <td>
                <asp:Button ID="btnConfirm"  style="font-size: 15px; font-family: 'Courier New'" runat="server" Text="Confirm Order" BorderStyle="None" 
                    onmouseover="this.style.color='#00FF90'"

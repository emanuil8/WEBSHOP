<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="confirmation.aspx.cs" Inherits="WebShop.WebForm11" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="font-size: 15px; text-align:left; margin-left:auto; margin-right:auto; margin-top: auto; border:5px double #231f20; background: #ffffff">
        ...
        <tr>
            <td colspan="2" style="text-align: center">
                <asp:Button ID="btnGoBack"  style="font-size: 15px; font-family: 'Courier New'; width: 77px;" runat="server" Text="Go Back" BorderStyle="None" 
